...
public class PushExample {
    ...
    protected static final String APP_KEY ="e49b546f62755c69d68ae177";
    protected static final String MASTER_SECRET = "9475ded44374737553897f39";
...
//        PushPayload payload = buildPushObject_all_alias_alert();
	...
	public static void TimePush(String title,String content,String apikey,String apimaster) {
		ClientConfig clientConfig = ClientConfig.getInstance();
        final JPushClient jpushClient = new JPushClient(apimaster, apikey, null, clientConfig);
        // Here you can use NativeHttpClient or NettyHttpClient or ApacheHttpClient.
        // Call setHttpClient to set httpClient,
        // If you don't invoke this method, default httpClient will use NativeHttpClient.
//        ApacheHttpClient httpClient = new ApacheHttpClient(authCode, null, clientConfig);
